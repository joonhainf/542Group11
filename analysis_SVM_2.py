...
##Create a binary variable which will be 0 if there is a low ratio and 1 if there is a ratio at 10 or above
#0 will be a "Mediocre" reputation and 1 will be "Great"

df['Ratio'] = df['Positive Reviews']/df['Negative Reviews']
df['Reputation'] = [1 if x >= 10 else 0  for x in df['Ratio']]
...
features = df[['Positive Reviews','CCU']]
